...
const baseUrl = "https://expertgateway-staging.findanexpert.net/";
...
export const addNewPaymentMethod = (object: any) => {
  return createApiConfigAndRequest(
    "post",
    `${paymentApi}OneTimePayment/SavePaymentMethod`,
    object
  );
};
...
export const getAllChildServices = (id: any) => {
  return createApiConfigAndRequest(
    "get",
    `${serviceInventoryApi}Service/GetAllChildServices?id=${id}`
  );
};
