        ...
        >
            ...
            <div className="row">
              <div className="col-md-6 ">
                <div className="row">
                  ...
                  <div className="col-md-10 col-7 px-4 text-left pt-2">
                    ...
                    <p className="subheading_profile pt-0 p-0"> Account ID {business.businessId}</p>
                  </div>
                </div>
              </div>
          ...
          <div className="pt-4">
            <p className="basic_text">
              <img className="img-fluid" src="/svgicons/person.svg" />Business Name
            </p>
          </div>
          ...
          <div className="pb-4 ">
            <div className="pt-4">
              <p className="basic_text">
                {" "}
                <img className="img-fluid" src="/imagess/redicons/home.png" /> Business Type
              </p>
            </div>
            <div className="border_for_all_pages">
              <Link
          ...
          <div className="pb-4">
            <div className="pt-1">
              <p className="basic_text">
                {" "}
                <img className="img-fluid" src="/imagess/redicons/call.png" /> Business Number
              </p>
            </div>
            <div className="border_for_all_pages">
              <Link
          ...
          <div className="pb-4">
            <div className="pt-1 pb-3 ">
              <span className="basic_text">
                ...
                &nbsp;
              </span><span className="img_small basic_text">Website</span>
            </div>
            <div className="border_for_all_pages">
          ...
          <div className="row">
            ...
            <div className="col-md mt-2">
              <div className="col-md-12 profile_cards">
                <img className="img-fluid pb-3  " src="/imagess/redicons/usersss.png" />
                <Link
                  href="/userProfile/settings/settings"
                  className="style_a_tag"
                >
            ...
            <div className="col-md mt-2">
              <div className="col-md-12 profile_cards">
                <img className="img-fluid pb-3  " src="/imagess/redicons/docc.png" />
                <Link
                  href="/userProfile/settings/settings"
                  className="style_a_tag"
                >
