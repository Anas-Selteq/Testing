              ...
              <div>
               ...
               <span className="text_for_all_selection">Male</span> 
                ...
                <input
                  ...
                  onChange={handleOptionChange}
                />
                <span className="text_for_all_selection">Transgender</span>
              </div>
            </div>
          </div>
          {isLoading ? (
            ...
            <div
              className="d-flex justify-content-end button_size_fixed1"
            >
              <button className="btn btn-danger mt-5" onClick={onClickHandler}>
                Save Changes
              </button>
            </div>
          )}
