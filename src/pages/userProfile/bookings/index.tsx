...
function Bookings() {
  ...
  const fetchDataofaalbookings = async () => {
    try {
      ...
      const apiUrl = `https://expertgateway-staging.findanexpert.net/bookingorder_svc/pb/getBookingList/?customerId=${profile?.userId}&page=1`;
      // const apiUrl = 'https://gateway.findanexpert.net/bookingorder_svc/pb/getBookingList/?customerId=1&page=1';
      const response = await axios.get(apiUrl);
      setAllbookings(response.data.result.data);
    } catch (error) {
      // Handle errors here
  ...
  function getallbookings(userId: any) {
    getBookingListByCustomerId(userId)
      .then((res) => {
        setAllbookings(res.data.result.data[0].data);
      })
      .catch((e) => alert(e));
  }
  ...
  console.log("Bookings list <><>><<><><>", allbookings)
        ...
        <div className="side_nav_1_right">
          ...
          <div className="col-md-12 background_sidenav_one ">
            <div className="col-md-12 bg-white border_of_subheader px-3 ">
              <div className="row">
                <div className="col-md-5 ">
                  <div className="row">
                    ...
                    <div
                      className={`col-md-3 col-4 equal_padding text-center ${
                        tabswitch === 0
                ...
                <div className="col-md-7 m-auto text-end">
                  ...
                  <span className="color_bookings1">
                    ...
                    <button
                className="button_set_search px-2"
              >
              ...
              >
               <img className="img-fluid" src="/imagess/redicons/vector.png" />&nbsp; Filter
              </button>
                </div>
              </div>
            </div>
            <div className="col-md-12 fix_height_bookings" id="style-2">
              {/* content for page ----------------------------  */}
              {tabswitch === 0 ? (
                // For Bookings Tab ---------------------------------------------------------------------
                <>
                ...
                <div  >
                        {allbookings?.map((item: any, index: any) => {
                          console.log("Bookings list all <><>><<><><>", item);
                          return (
                            <div
                              key={index}
                            ...
                            >
                              <div className="row">
                                  ...
                                  <div className="row">
                                    <div className="col-md-2 col-3 px-md-0 px-2">
                                      <img
                                        ...
                                        src="/imagess/redicons/booking.png"
                                      />
                                    </div>
                                    <div className="col-md-10 px-md-0 col-9 m-auto">
                                ...
                                <div className="col-md-6 col-12 text-end m-auto">
                                  <p className="mb-0 london_text_sub1">
                                  {/* <Moment format="h:mm A">
                                    {item?.createdAt}
                                  </Moment> */}
                                  {item?.dateJson[0]?.timeFrom} to  {item?.dateJson[0]?.timeTo}
                                    &nbsp;&nbsp;&nbsp;
                                    <Image src="/assets/images/rightt.png" alt="keyright" height={11.19}
                                    width={6.33}
                                  />
                                  </p>
                                </div>
