...
//   };
  ...
  const flowAndPurchaseOrderHandler = () =>{
    localStorage.removeItem('orderId');
    router.push("/userProfile/bookings");
    
  }

  return (
    <Layout2>
    <div style={{ overflowY: "scroll", height: "100vh", paddingBottom: "20%" }}>
      <div className="col-md-12 px-5 mt-5">
        <PurchaseSummary purchaseOrder={purchaseOrder} />
        <div className="col-md-12 bg-white px-3 py-3 border_rad_notes mb-3">
          <Demo />
        </div>
        <div className="text-end">
          <button
            className="btn btn-danger color_danger mt-3 px-4 py-1 "
